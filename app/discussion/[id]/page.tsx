            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
                ...
                <Card className="border-wine-200">
                    ...
                    <CardContent className="flex gap-6 text-gray-600">
                        <div className="flex items-center gap-1"><MessageCircle className="w-4 h-4"/>{comments.length}
                        </div>
                ...
                <Card className="border-wine-200">
                    ...
                    <CardContent className="space-y-4">
                        <div className="flex gap-2">
                            <Button onClick={() => setCommentStance("agree")}
                                    variant={commentStance === "agree" ? "default" : "outline"}
                                    className={commentStance === "agree" ? "bg-green-600 hover:bg-green-700" : ""}>찬성</Button>
                            <Button onClick={() => setCommentStance("disagree")}
                                    variant={commentStance === "disagree" ? "default" : "outline"}
                                    className={commentStance === "disagree" ? "bg-red-600 hover:bg-red-700" : ""}>반대</Button>
                            <Button onClick={() => setCommentStance("neutral")}
                                    variant={commentStance === "neutral" ? "default" : "outline"}
                                    className={commentStance === "neutral" ? "bg-gray-600 hover:bg-gray-700" : ""}>중립</Button>
                        </div>
                        <Textarea
                            ...
                            <Card key={comment.id} className="border-wine-200">
                                <CardContent className="pt-6 flex gap-4">
                                    <Avatar>
                                        ...
                                        <AvatarFallback
                                            className="bg-wine-100 text-wine-800">{comment.avatar}</AvatarFallback>
                                    </Avatar>
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {comment.references.map((ref, idx) => (
                                                        ...
                                                        >
                                                            ...
                                                            <span
                                                                className="text-sm text-red-700 font-medium">{ref.title}</span>
                                                        </a>
                                                    ))}
                                                </div>
                                            </div>
